...
class TabBarController: UITabBarController {
    ...
    func addChildViewControllers() {
        ...
        setupOneChildViewController("首页", image: "menu_goddess_dy", selectedImage: "Assets_Tabbar_Icon_Love_Selected", controller: JSCHomeViewController.init())
        setupOneChildViewController("游戏", image: "menu_youxi_nor", selectedImage: "menu_goddess_dyse", controller: JSCHomeViewController.init())
        setupOneChildViewController("娱乐", image: "menu_yule_nor", selectedImage: "Assets_Tabbar_Icon_Home_Selected", controller: JSCHomeViewController.init())
        setupOneChildViewController("小葱秀", image: "menu_goddess_nor", selectedImage: "menu_goddess_sel", controller: JSCHomeViewController.init())
