//
//  JSCBaseNavigationController.swift
//  jisuchou
//
...
class JSCBaseNavigationController: UINavigationController,UINavigationControllerDelegate  {
...
//            viewController.navigationItem.rightBarButtonItem = setRightButton()
    ...
    func setBackBarButtonItem() -> UIBarButtonItem {
        ...
        backButton.addTarget(self, action: #selector(JSCBaseNavigationController.backClick), for: .touchUpInside)
    ...
    func setRightButton() -> UIBarButtonItem {
        ...
        searchItem.addTarget(self, action: #selector(JSCBaseNavigationController.searchClick), for: .touchUpInside)
